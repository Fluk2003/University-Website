      ...
      <div class="topbar d-flex align-items-center">
        ...
        >
          <div class="d-none d-md-flex align-items-center">
            <i class="bi bi-clock me-1"></i>วันจันทร์ - วันอาทิตย์ เวลา 08:30 น.
            - 16:30 น. (ยกเว้นวันหยุดนักขัตฤกษ์)
          </div>
          <div class="d-flex align-items-center">
            <i class="bi bi-phone me-1"></i> 0-4221-1040 ต่อ 1752-1755
          </div>
        </div>
      </div>
      <!-- End Top Bar -->
            ...
            <li><a href="#doctors">Doctors</a></li> -->
              ...
              <li class="dropdown">
                ...
                <ul>
                  ...
                  <li class="dropdown">
                    <a href="#"
                      ><span>ประวัติของหน่วยงาน</span>
                      <i class="bi bi-chevron-down toggle-dropdown"></i
                    ></a>
                    <ul>
                      <li><a href="starter-page.html">วิสัยทัศน์</a></li>
                      <li><a href="#">พันธกิจ</a></li>
                      <li><a href="#">ค่านิยม</a></li>
                      <li><a href="#">กลยุทธ์ของหน่วยงาน</a></li>
                    </ul>
                  </li>
              ...
              <li class="dropdown">
                ...
                <ul>
                  ...
                  <li><a href="#">ค่าเทอมการศึกษา</a></li>
                </ul>
              </li>
              ...
              <li class="dropdown">
                ...
                ></a>
                <ul>
                  <li><a href="#">ระบบสารสนเทศหลักสูตร</a></li>
                  <li class="dropdown">
                    <a href="#"
                      ><span>คู่มือการจัดทำหลักสูตร</span>
                      <i class="bi bi-chevron-down toggle-dropdown"></i
                    ></a>
                    <ul>
                  ...
                  <li class="dropdown">
                    <a href="#"
                      ><span>การจัดทำ มคอ.</span>
                      <i class="bi bi-chevron-down toggle-dropdown"></i
                    ></a>
                    <ul>
                      <li><a href="#">คู่มือการจัดทำ มคอ.</a></li>
                      <li>
                        <a href="#"
                          >ระบบสารสนเทศการจัดทำ <br />
                          มคอ.</a
                        >
                      </li>
                      <li>
                        <a href="#"
                          >ระบบรับทราบหลักสูตร <br />
                          (CHECO)</a
                        >
                      </li>
                    </ul>
              ...
              <li class="dropdown">
                ...
                <ul>
                  ...
                  <li><a href="#">ระบบบริการนักศึกษา</a></li>
                  <li class="dropdown">
                    <a href="#"
                  ...
                  <li class="dropdown">
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="#">ขอแจ้งรายวิชา<br />ลงทะเบียนเรียนซ้ำ</a>
                      </li>
                  ...
                  <li class="dropdown">
                    <a href="#"
                      ><span
                        >คู่มือการขอเอกสาร <br />
                        สำคัญทางการศึกษา</span
                      >
                      <i class="bi bi-chevron-down toggle-dropdown"></i
                    ></a>
                    <ul>
                ...
                <ul>
                  ...
                  <li class="dropdown">
                    ...
                    <ul>
                      ...
                      <li>
                        <a href="#"
                          >การให้บริการงานส่งเสริม <br />
                          วิชาการ</a
                        >
                      </li>
                      <li>
                        <a href="#"
                          >งานหลักสูตรและมาตรฐาน <br />
                          หลักสูตร</a
                        >
                      </li>
                    </ul>
                  ...
                  <li class="dropdown">
                    <a href="#"
                      ><span
                        >ผลการประเมินความ<br />พึงพอใจของ <br />
                        สำนักฯ</span
                      >
                      <i class="bi bi-chevron-down toggle-dropdown"></i
                    ></a>
